    ...
    return <section className="py-24 overflow-hidden">
        <div className="container">
            ...
            <h2 className="text-6xl font-medium mt-6 ">
                Connects With <span className="text-[#E45A92]">Tech You Love</span>
            </h2>
            <p className="text-white/50 mt-4 text-lg">
                Our club integrates with popular developer tools, making it easy to collaborate, learn, and build projects together.
            </p>
                </div>
                <div>
